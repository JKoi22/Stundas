...
def novciem(ciemats):
     ...
     with open(y, "w", newline="", encoding="utf-8") as fails:
               rakst=csv.writer(fails)
               rakst.writerow(aa)
izvēlne=int(input("ievadi skaitli 1-6 1=skaits novadā, 2=skaits pagastā 3=skaits ciemā/pilsētā 4=novada pieturu nosaukumi 5=pagasta pieturu nosaukumi 6=ciema/pilsētas pieturu nosaukumi"))
if izvēlne==1:
